...
class SQLi15:
    ...
    def login(self):
        ...
        data = {'username':self.username, 'password':self.password, 'csrf':self.csrf_token}
        r = requests.post(self.login_url, cookies=self.cookies, data=data, proxies=self.proxies, verify=False)
